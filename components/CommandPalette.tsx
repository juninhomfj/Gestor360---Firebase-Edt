...
import { Search, ArrowRight, LayoutDashboard, ShoppingCart, PieChart, Users, Settings, Moon, Sun, Monitor, LogOut, Plus } from 'lucide-react';
        ...
        >
            ...
            <div className="max-h-[60vh] overflow-y-auto py-2">
                {filteredActions.length === 0 ? (
                    <div className="p-8 text-center text-gray-500">Nenhum comando encontrado.</div>
                ) : (
